            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="房屋编号">
                  ...
                  <el-button size="small" type="primary" @click="innerVisible=true" style="width:28%;">选择房屋</el-button>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="固定电话" >
                  <el-input size="small" v-model="temp.ZHGDDH">
                  </el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="租赁起始日期">
                                    <el-date-picker style="width:100%" format="yyyy-MM-dd" size="small" v-model="temp.ZLQSRQ"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="租赁终止日期">
                                    <el-date-picker style="width:100%" format="yyyy-MM-dd" size="small" v-model="temp.ZLZZRQ"></el-date-picker>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="租赁月数">
                  <el-input size="small" v-model="temp.ZLYS">
                  </el-input>
                </el-form-item>
              </el-col>
  <el-col :span="8">
...
radio: '',
      ...
      rules: {
        ...
        JZR: [
          { required: true, message: "物业基准日期", trigger: "change" }
        ],
        // FZFJE: [
