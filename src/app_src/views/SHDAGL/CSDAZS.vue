  ...
  <div id="CZSHDA" class="app-container calendar-list-container">
    ...
    >
      <el-card style="margin-top:20px;">
        ...
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="装修押金" prop="ZXYJ1">
        ...
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="消防保证金" prop="XFBZJ1">
      ...
      <el-card style="margin-top:20px;">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="物业费标准" prop="WYDJ1">
...
export default {
  ...
  methods: {
    ...
    updateData() {
      this.$refs["newtemp"].validate(valid => {
        if (valid) {
      ...
      if (
        ...
        GetShopInfoDetail(listQuery).then(res => {
          if (res.data.code === 2000) {
            ...
            this.$nextTick(() => {
              this.$refs["newtemp"].clearValidate();
            });
          }
        });
      } else {
