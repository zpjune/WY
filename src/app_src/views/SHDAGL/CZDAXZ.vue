  ...
  <div id="CZDAXZ">
          ...
          <el-row>
            <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8" disabled>
              <el-form-item label="电子邮箱">
                <el-input size="small" v-model="temp.E_MAIL"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
    ...
    >
      <el-card style="margin-top:20px;">
        ...
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现费缴纳方式" prop="WYJFFS">
              <el-select style="width:100%" size="small" v-model="newtemp.WYJFFS">
                <el-option
                  v-for="(item,key) in PAY_WAYOPTIONS"
                  :key="key"
                  :value="item.Code"
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现物业费标准" prop="WYDJ">
              <el-input size="small" v-model="newtemp.WYDJ">
                <template slot="append">元/平/月</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现物业基准日期" prop="WYJZSJ">
              <el-date-picker
                style="width:100%"
                size="mini"
                v-model="newtemp.WYJZSJ"
                value-format="yyyy-MM-dd"
              ></el-date-picker>
            </el-form-item>
          </el-col>
    ...
    <el-card style="margin-top:20px;">
      ...
      <div>
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现起始日期" >
              <el-date-picker
                style="width:100%"
                value-format="yyyy-MM-dd"
                size="small"
                v-model="newtemp.ZLKSSJ"
              ></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现终止日期" >
              <el-date-picker
                style="width:100%"
                value-format="yyyy-MM-dd"
                size="small"
                v-model="newtemp.ZLZZSJ"
              ></el-date-picker>
            </el-form-item>
          </el-col>

          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现租赁总额" >
              <el-input size="small" v-model="newtemp.ZLZE"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现租赁押金" >
              <el-input size="small" v-model="newtemp.ZLYJ"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现租赁月数" >
              <el-input size="small" v-model.number="newtemp.ZLYS"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="现缴费方式" >
              <el-select style="width:100%" size="small" v-model="newtemp.ZJJFFS">
                <el-option
                  v-for="(item,key) in PAY_WAYOPTIONS"
                  :key="key"
                  :value="item.Code"
...
export default {
  ...
  methods: {
    ...
    GetEditData() {
      if (
        this.$route.query.param != undefined &&
        this.$route.query.param != ""
      ) {
        this.dialogStatus = "update";
        let listQuery = {
          CZ_SHID: this.$route.query.param
        };
