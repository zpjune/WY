  ...
  <div id="login-container" class="login-container">
    <el-container>
      ...
      <el-main>
        <div class="divbg">
          <el-row >
            <el-col :span="6" :offset="6" style="margin-top:100px;">
                <img src="../../../frame_src/imgs/leftpadding.png" alt="" style="width:100%;height:460px">
            </el-col>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <div v-for="(item,index) in list" :key="index">
                            <el-dropdown-item :command="item.key">
                              <span style="font-size:10px">{{item.key}}</span>
                            </el-dropdown-item>
                          </div>
                        </el-dropdown-menu>
                      </el-dropdown>
...
.login-container {
  ...
  .el-main {
    ...
    margin: 0 auto;
    .divbg {
      background: url("../../../frame_src/imgs/pufengbackground2.png") fixed
        center no-repeat;
      //min-width: 1366px;
      //min-width: 500px;
      height: 100%;
